...
//    	System.out.println(shelves); 
    ...
    @GetMapping("/warehouse/{corpIdx}")
    public List<Warehouses> getWarehousesByCorpIdx(@PathVariable String corpIdx) {
        return warehousesMapper.findWarehousesByCorpIdx(corpIdx);
    }
