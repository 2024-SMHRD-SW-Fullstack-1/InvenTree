...
public class WarehousesController {
	...
	public ResponseEntity<String> deleteWarehousesAndShelves(@RequestBody Map<String, List<Integer>> requestData) {
	...
	public ResponseEntity<String> insertShelves(@RequestBody List<Shelves> shelves) {
		...
		try {
			...
			e.printStackTrace(); // 예외 스택 트레이스 출력
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("선반 정보 추가 에러: " + e.getMessage());
		}
	}
